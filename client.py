...
logo_path = r'C:\final_project_yes\project_logo.png'
hobbies_picture_path = r'C:\final_project_yes\hobby-picture.png'
search_picture_path = r'C:\final_project_yes\search-curr-picture.jpg'
refresh_picture_path = r'C:\final_project_yes\refresh_picture.jpg'
...
def connect():
    ...
    my_socket.connect(("172.18.55.8", 86))
    return my_socket
